<template>
  <q-page class="q-pa-md bg-white">
    <div id="printData">
      <div class="q-text-weight-bold text-h6 text-center q-pb-md bg-white">ASKAN INTRA ANESTESI</div>
      ...
      <q-form @submit="simpan">
        <div class="row no-wrap items-center q-mb-sm">
          ...
          <div class="col-10">
            <q-input v-model="store.formintra.askan_data.masalah_kesehatan_anestesi" dense type="text" autogrow />
          </div>
        </div>
        <div class="row no-wrap items-center q-mb-sm">
          <div class="col-2">
          ...
          <div class="col-10">
            <q-input dense type="text" autogrow v-model="store.formintra.askan_data.waktu">
              <template v-slot:append>
                <q-icon name="event">
                  <q-popup-proxy cover transition-show="scale" transition-hide="scale"
                    class="q-gutter-md row items-start">
                    <q-date v-model="store.formintra.askan_data.waktu" mask="YYYY-MM-DD HH:mm" />
                    <q-time v-model="store.formintra.askan_data.waktu" mask="YYYY-MM-DD HH:mm" />
                  </q-popup-proxy>
                </q-icon>
              </template>
            </q-input>
        ...
        <div class="row no-wrap items-center q-mb-sm">
          ...
          <div class="col-10">
            <q-input dense type="text" autogrow v-model="store.formintra.askan_data.intervensi" />
          </div>
        </div>
        <div class="row no-wrap items-center q-mb-sm">
          <div class="col-2">
          ...
          <div class="col-10">
            <q-input dense type="text" autogrow v-model="store.formintra.askan_data.implementasi" />
          </div>
        </div>
        ...
        <div class="row no-wrap items-center q-mb-sm">
          ...
          <div class="col-10">
            <q-input v-model="store.formintra.askan_data.s" type="text" autogrow />
          </div>
        </div>
        <div class="row no-wrap items-center q-mb-sm">
          <div class="col-2">
          ...
          <div class="col-10">
            <q-input v-model="store.formintra.askan_data.o" dense type="text" autogrow />
          </div>
        </div>
        <div class="row no-wrap items-center q-mb-sm">
          <div class="col-2">
          ...
          <div class="col-10">
            <q-input dense v-model="store.formintra.askan_data.a" type="text" autogrow />
          </div>
        </div>
        <div class="row no-wrap items-center q-mb-sm">
          <div class="col-2">
          ...
          <div class="col-10">
            <q-input v-model="store.formintra.askan_data.p" dense type="text" autogrow />
          </div>
        </div>
        <div class="row no-wrap items-center q-mb-sm">
          <div class="col-2">
          ...
          <div class="col-10">
            <q-input v-model="store.formintra.askan_data.nama_ttd" dense type="text" autogrow />
          </div>
        </div>
